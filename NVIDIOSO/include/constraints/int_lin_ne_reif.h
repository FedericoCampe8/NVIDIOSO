...
#ifndef __NVIDIOSO__int_lin_ne_reif__
#define __NVIDIOSO__int_lin_ne_reif__

#include "base_constraint.h"
#include "int_variable.h"

class IntLinNeReif : public BaseConstraint {  
public:
    /**
     * Basic constructor.
     ...
     */
    IntLinNeReif ( std::string& constraint_name );
