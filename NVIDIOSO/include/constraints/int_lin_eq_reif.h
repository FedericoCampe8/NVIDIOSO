...
#ifndef __NVIDIOSO__int_lin_eq_reif__
#define __NVIDIOSO__int_lin_eq_reif__

#include "base_constraint.h"
#include "int_variable.h"

class IntLinEqReif : public BaseConstraint {  
public:
    /**
     * Basic constructor.
     ...
     */
    IntLinEqReif ( std::string& constraint_name );
