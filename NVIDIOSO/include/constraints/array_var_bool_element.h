...
#ifndef __NVIDIOSO__array_var_bool_element__
#define __NVIDIOSO__array_var_bool_element__

#include "base_constraint.h"
#include "int_variable.h"

class ArrayVarBoolElement : public BaseConstraint {  
public:
    /**
     * Basic constructor.
     ...
     */
    ArrayVarBoolElement ( std::string& constraint_name );
