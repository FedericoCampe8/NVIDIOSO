...
#ifndef __NVIDIOSO__array_var_int_element__
#define __NVIDIOSO__array_var_int_element__

#include "base_constraint.h"
#include "int_variable.h"

class ArrayVarIntElement : public BaseConstraint {  
public:
    /**
     * Basic constructor.
     ...
     */
    ArrayVarIntElement ( std::string& constraint_name );
