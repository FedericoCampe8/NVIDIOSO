...
#ifndef __NVIDIOSO__array_set_element__
#define __NVIDIOSO__array_set_element__

#include "base_constraint.h"
#include "int_variable.h"

class ArraySetElement : public BaseConstraint {  
public:
    /**
     * Basic constructor.
     ...
     */
    ArraySetElement ( std::string& constraint_name );
