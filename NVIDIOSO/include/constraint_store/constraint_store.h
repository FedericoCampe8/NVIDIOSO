...
public:
    ...
    /**
     * Sets constraint propagation.
     * Thic set increases the time spent during propagation but reduces
     * the total exectuion time.
     * @param con_check boolean value representing whether or not the
     *        satisfiability check should be performed (default: true).
     */
