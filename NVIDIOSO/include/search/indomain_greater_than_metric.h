//
//  indomain_greater_than_metric.h
//  iNVIDIOSO
//
...
#ifndef __NVIDIOSO__indomain_greater_than_metric__
#define __NVIDIOSO__indomain_greater_than_metric__

#include "value_choice_metric.h"

class InDomainGreaterThan : public ValueChoiceMetric {
private:
...
public:
   ...
   * @param comparator integer value to compare to return a strictly greater than value.
   ...
   * @param var the (pointer to) variable for which a value if needed.
   * @return the value to assign to var.
   * @note this method returns a value strictly greater than previous value at each invokation.
   * @note if no value is available it returns the min domain's element and resets _current_val_lookup. 
   */
...
#endif /* defined(__NVIDIOSO__indomain_greater_than_metric__) */
