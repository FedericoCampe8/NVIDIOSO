...
#ifndef __NVIDIOSO__cuda_int_lin_ne_reif__
#define __NVIDIOSO__cuda_int_lin_ne_reif__

#include "cuda_constraint.h"

class CudaIntLinNeReif : public CudaConstraint {
public:
   ...
   */
  __device__ CudaIntLinNeReif ( int n_id, int n_vars, int n_args,
                                int* vars, int* args,
                                int* domain_idx, uint* domain_states );
  
  __device__ ~CudaIntLinNeReif ();
