...
#ifndef __NVIDIOSO__cuda_int_plus__
#define __NVIDIOSO__cuda_int_plus__

#include "cuda_constraint.h"

class CudaIntPlus : public CudaConstraint {
public:
   ...
   */
  __device__ CudaIntPlus ( int n_id, int n_vars, int n_args,
                           int* vars, int* args,
