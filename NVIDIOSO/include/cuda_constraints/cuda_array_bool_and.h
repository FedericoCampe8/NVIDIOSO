...
#ifndef __NVIDIOSO__cuda_array_bool_and__
#define __NVIDIOSO__cuda_array_bool_and__

#include "cuda_constraint.h"

class CudaArrayBoolAnd : public CudaConstraint {
public:
   ...
   */
  __device__ CudaArrayBoolAnd ( int n_id, int n_vars, int n_args,
                                int* vars, int* args,
                                int* domain_idx, uint* domain_states );
  
  __device__ ~CudaArrayBoolAnd ();
