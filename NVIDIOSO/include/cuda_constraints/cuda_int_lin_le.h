...
#ifndef __NVIDIOSO__cuda_int_lin_le__
#define __NVIDIOSO__cuda_int_lin_le__

#include "cuda_constraint.h"

class CudaIntLinLe : public CudaConstraint {
public:
   ...
   */
  __device__ CudaIntLinLe ( int n_id, int n_vars, int n_args,
                            int* vars, int* args,
                            int* domain_idx, uint* domain_states );
  
  __device__ ~CudaIntLinLe ();
