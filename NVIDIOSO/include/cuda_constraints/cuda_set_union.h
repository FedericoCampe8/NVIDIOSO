...
#ifndef __NVIDIOSO__cuda_set_union__
#define __NVIDIOSO__cuda_set_union__

#include "cuda_constraint.h"

class CudaSetUnion : public CudaConstraint {
public:
   ...
   */
  __device__ CudaSetUnion ( int n_id, int n_vars, int n_args,
                            int* vars, int* args,
                            int* domain_idx, uint* domain_states );
  
  __device__ ~CudaSetUnion ();
