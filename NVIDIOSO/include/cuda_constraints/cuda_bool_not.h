...
#ifndef __NVIDIOSO__cuda_bool_not__
#define __NVIDIOSO__cuda_bool_not__

#include "cuda_constraint.h"

class CudaBoolNot : public CudaConstraint {
public:
   ...
   */
  __device__ CudaBoolNot ( int n_id, int n_vars, int n_args,
                           int* vars, int* args,
                           int* domain_idx, uint* domain_states );
  
  __device__ ~CudaBoolNot ();
