...
#ifndef __NVIDIOSO__cuda_bool_eq_reif__
#define __NVIDIOSO__cuda_bool_eq_reif__

#include "cuda_constraint.h"

class CudaBoolEqReif : public CudaConstraint {
public:
   ...
   */
  __device__ CudaBoolEqReif ( int n_id, int n_vars, int n_args,
                              int* vars, int* args,
                              int* domain_idx, uint* domain_states );
  
  __device__ ~CudaBoolEqReif ();
