...
#ifndef __NVIDIOSO__cuda_int_lin_le_reif__
#define __NVIDIOSO__cuda_int_lin_le_reif__

#include "cuda_constraint.h"

class CudaIntLinLeReif : public CudaConstraint {
public:
   ...
   */
  __device__ CudaIntLinLeReif ( int n_id, int n_vars, int n_args,
                             	int* vars, int* args,
                             	int* domain_idx, uint* domain_states );
  
  __device__ ~CudaIntLinLeReif ();
