...
#ifndef __NVIDIOSO__cuda_bool_lt__
#define __NVIDIOSO__cuda_bool_lt__

#include "cuda_constraint.h"

class CudaBoolLt : public CudaConstraint {
public:
   ...
   */
  __device__ CudaBoolLt ( int n_id, int n_vars, int n_args,
                          int* vars, int* args,
                          int* domain_idx, uint* domain_states );
  
  __device__ ~CudaBoolLt ();
