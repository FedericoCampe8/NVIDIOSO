...
#ifndef __NVIDIOSO__cuda_bool_clause__
#define __NVIDIOSO__cuda_bool_clause__

#include "cuda_constraint.h"

class CudaBoolClause : public CudaConstraint {
public:
   ...
   */
  __device__ CudaBoolClause ( int n_id, int n_vars, int n_args,
                              int* vars, int* args,
                              int* domain_idx, uint* domain_states );
  
  __device__ ~CudaBoolClause ();
