...
#ifndef __NVIDIOSO__cuda_array_bool_element__
#define __NVIDIOSO__cuda_array_bool_element__

#include "cuda_constraint.h"

class CudaArrayBoolElement : public CudaConstraint {
public:
   ...
   */
  __device__ CudaArrayBoolElement ( int n_id, int n_vars, int n_args,
                                    int* vars, int* args,
                                    int* domain_idx, uint* domain_states );
  
  __device__ ~CudaArrayBoolElement ();
