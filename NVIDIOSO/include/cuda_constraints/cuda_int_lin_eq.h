...
#ifndef __NVIDIOSO__cuda_int_lin_eq__
#define __NVIDIOSO__cuda_int_lin_eq__

#include "cuda_constraint.h"

class CudaIntLinEq : public CudaConstraint {
public:
   ...
   */
  __device__ CudaIntLinEq ( int n_id, int n_vars, int n_args,
                            int* vars, int* args,
                            int* domain_idx, uint* domain_states );
  
  __device__ ~CudaIntLinEq ();
