...
#ifndef __NVIDIOSO__cuda_int_abs__
#define __NVIDIOSO__cuda_int_abs__

#include "cuda_constraint.h"

class CudaIntAbs : public CudaConstraint {
public:
   ...
   */
  __device__ CudaIntAbs ( int n_id, int n_vars, int n_args,
                          int* vars, int* args,
                          int* domain_idx, uint* domain_states );
  
  __device__ ~CudaIntAbs ();
