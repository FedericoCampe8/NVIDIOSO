...
#ifndef __NVIDIOSO__cuda_set_intersect__
#define __NVIDIOSO__cuda_set_intersect__

#include "cuda_constraint.h"

class CudaSetIntersect : public CudaConstraint {
public:
   ...
   */
  __device__ CudaSetIntersect ( int n_id, int n_vars, int n_args,
                                int* vars, int* args,
                                int* domain_idx, uint* domain_states );
  
  __device__ ~CudaSetIntersect ();
