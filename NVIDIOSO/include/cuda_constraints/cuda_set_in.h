...
#ifndef __NVIDIOSO__cuda_set_in__
#define __NVIDIOSO__cuda_set_in__

#include "cuda_constraint.h"

class CudaSetIn : public CudaConstraint {
public:
   ...
   */
  __device__ CudaSetIn ( int n_id, int n_vars, int n_args,
                         int* vars, int* args,
                         int* domain_idx, uint* domain_states );
  
  __device__ ~CudaSetIn ();
