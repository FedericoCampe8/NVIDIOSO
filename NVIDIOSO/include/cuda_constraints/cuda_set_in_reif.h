...
#ifndef __NVIDIOSO__cuda_set_in_reif__
#define __NVIDIOSO__cuda_set_in_reif__

#include "cuda_constraint.h"

class CudaSetInReif : public CudaConstraint {
public:
   ...
   */
  __device__ CudaSetInReif ( int n_id, int n_vars, int n_args,
                             int* vars, int* args,
                             int* domain_idx, uint* domain_states );
  
  __device__ ~CudaSetInReif ();
