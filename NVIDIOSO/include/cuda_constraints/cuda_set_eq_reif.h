...
#ifndef __NVIDIOSO__cuda_set_eq_reif__
#define __NVIDIOSO__cuda_set_eq_reif__

#include "cuda_constraint.h"

class CudaSetEqReif : public CudaConstraint {
public:
   ...
   */
  __device__ CudaSetEqReif ( int n_id, int n_vars, int n_args,
                             int* vars, int* args,
                             int* domain_idx, uint* domain_states );
  
  __device__ ~CudaSetEqReif ();
