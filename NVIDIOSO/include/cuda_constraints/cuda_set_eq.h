...
#ifndef __NVIDIOSO__cuda_set_eq__
#define __NVIDIOSO__cuda_set_eq__

#include "cuda_constraint.h"

class CudaSetEq : public CudaConstraint {
public:
   ...
   */
  __device__ CudaSetEq ( int n_id, int n_vars, int n_args,
                         int* vars, int* args,
                         int* domain_idx, uint* domain_states );
  
  __device__ ~CudaSetEq ();
