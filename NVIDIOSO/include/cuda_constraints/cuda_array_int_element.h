...
#ifndef __NVIDIOSO__cuda_array_int_element__
#define __NVIDIOSO__cuda_array_int_element__

#include "cuda_constraint.h"

class CudaArrayIntElement : public CudaConstraint {
public:
   ...
   */
  __device__ CudaArrayIntElement ( int n_id, int n_vars, int n_args,
                                   int* vars, int* args,
