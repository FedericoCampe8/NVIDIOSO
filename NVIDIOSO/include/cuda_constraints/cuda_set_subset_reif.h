...
#ifndef __NVIDIOSO__cuda_set_subset_reif__
#define __NVIDIOSO__cuda_set_subset_reif__

#include "cuda_constraint.h"

class CudaSetSubsetReif : public CudaConstraint {
public:
   ...
   */
  __device__ CudaSetSubsetReif ( int n_id, int n_vars, int n_args,
                                 int* vars, int* args,
                                 int* domain_idx, uint* domain_states );
  
  __device__ ~CudaSetSubsetReif ();
