...
#ifndef __NVIDIOSO__cuda_array_bool_or__
#define __NVIDIOSO__cuda_array_bool_or__

#include "cuda_constraint.h"

class CudaArrayBoolOr : public CudaConstraint {
public:
   ...
   */
  __device__ CudaArrayBoolOr ( int n_id, int n_vars, int n_args,
                               int* vars, int* args,
                               int* domain_idx, uint* domain_states );
  
  __device__ ~CudaArrayBoolOr ();
