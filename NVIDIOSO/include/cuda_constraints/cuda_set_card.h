...
#ifndef __NVIDIOSO__cuda_set_card__
#define __NVIDIOSO__cuda_set_card__

#include "cuda_constraint.h"

class CudaSetCard : public CudaConstraint {
public:
   ...
   */
  __device__ CudaSetCard ( int n_id, int n_vars, int n_args,
                           int* vars, int* args,
                           int* domain_idx, uint* domain_states );
  
  __device__ ~CudaSetCard ();
