...
#ifndef __NVIDIOSO__cuda_bool_le_reif__
#define __NVIDIOSO__cuda_bool_le_reif__

#include "cuda_constraint.h"

class CudaBoolLeReif : public CudaConstraint {
public:
   ...
   */
  __device__ CudaBoolLeReif ( int n_id, int n_vars, int n_args,
                              int* vars, int* args,
                              int* domain_idx, uint* domain_states );
  
  __device__ ~CudaBoolLeReif ();
