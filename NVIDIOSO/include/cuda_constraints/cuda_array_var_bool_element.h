...
#ifndef __NVIDIOSO__cuda_array_var_bool_element__
#define __NVIDIOSO__cuda_array_var_bool_element__

#include "cuda_constraint.h"

class CudaArrayVarBoolElement : public CudaConstraint {
public:
   ...
   */
  __device__ CudaArrayVarBoolElement ( int n_id, int n_vars, int n_args,
                                       int* vars, int* args,
                                       int* domain_idx, uint* domain_states );
  
  __device__ ~CudaArrayVarBoolElement ();
