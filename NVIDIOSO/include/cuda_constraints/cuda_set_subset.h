...
#ifndef __NVIDIOSO__cuda_set_subset__
#define __NVIDIOSO__cuda_set_subset__

#include "cuda_constraint.h"

class CudaSetSubset : public CudaConstraint {
public:
   ...
   */
  __device__ CudaSetSubset ( int n_id, int n_vars, int n_args,
                             int* vars, int* args,
                             int* domain_idx, uint* domain_states );
  
  __device__ ~CudaSetSubset ();
