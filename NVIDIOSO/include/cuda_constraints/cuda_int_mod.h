...
#ifndef __NVIDIOSO__cuda_int_mod__
#define __NVIDIOSO__cuda_int_mod__

#include "cuda_constraint.h"

class CudaIntMod : public CudaConstraint {
public:
   ...
   */
  __device__ CudaIntMod ( int n_id, int n_vars, int n_args,
                          int* vars, int* args,
                          int* domain_idx, uint* domain_states );
  
  __device__ ~CudaIntMod ();
