...
#ifndef __NVIDIOSO__cuda_bool_or__
#define __NVIDIOSO__cuda_bool_or__

#include "cuda_constraint.h"

class CudaBoolOr : public CudaConstraint {
public:
   ...
   */
  __device__ CudaBoolOr ( int n_id, int n_vars, int n_args,
                          int* vars, int* args,
                          int* domain_idx, uint* domain_states );
  
  __device__ ~CudaBoolOr ();
