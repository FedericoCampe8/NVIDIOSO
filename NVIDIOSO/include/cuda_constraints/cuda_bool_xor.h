...
#ifndef __NVIDIOSO__cuda_bool_xor__
#define __NVIDIOSO__cuda_bool_xor__

#include "cuda_constraint.h"

class CudaBoolXor : public CudaConstraint {
public:
   ...
   */
  __device__ CudaBoolXor ( int n_id, int n_vars, int n_args,
                           int* vars, int* args,
                           int* domain_idx, uint* domain_states );
  
  __device__ ~CudaBoolXor ();
