...
#ifndef __NVIDIOSO__cuda_set_le__
#define __NVIDIOSO__cuda_set_le__

#include "cuda_constraint.h"

class CudaSetLe : public CudaConstraint {
public:
   ...
   */
  __device__ CudaSetLe ( int n_id, int n_vars, int n_args,
                         int* vars, int* args,
                         int* domain_idx, uint* domain_states );
  
  __device__ ~CudaSetLe ();
