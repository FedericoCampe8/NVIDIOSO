...
#ifndef __NVIDIOSO__cuda_array_set_element__
#define __NVIDIOSO__cuda_array_set_element__

#include "cuda_constraint.h"

class CudaArraySetElement : public CudaConstraint {
public:
   ...
   */
  __device__ CudaArraySetElement ( int n_id, int n_vars, int n_args,
                                   int* vars, int* args,
                                   int* domain_idx, uint* domain_states );
  
  __device__ ~CudaArraySetElement ();
