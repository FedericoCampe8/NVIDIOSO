...
#ifndef __NVIDIOSO__cuda_array_var_int_element__
#define __NVIDIOSO__cuda_array_var_int_element__

#include "cuda_constraint.h"

class CudaArrayVarIntElement : public CudaConstraint {
public:
   ...
   */
  __device__ CudaArrayVarIntElement ( int n_id, int n_vars, int n_args,
                                      int* vars, int* args,
                                      int* domain_idx, uint* domain_states );
  
  __device__ ~CudaArrayVarIntElement ();
