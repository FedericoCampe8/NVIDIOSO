...
#ifndef __NVIDIOSO__cuda_set_lt__
#define __NVIDIOSO__cuda_set_lt__

#include "cuda_constraint.h"

class CudaSetLt : public CudaConstraint {
public:
   ...
   */
  __device__ CudaSetLt ( int n_id, int n_vars, int n_args,
                         int* vars, int* args,
                         int* domain_idx, uint* domain_states );
  
  __device__ ~CudaSetLt ();
