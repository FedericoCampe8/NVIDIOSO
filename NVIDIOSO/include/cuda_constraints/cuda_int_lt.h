...
#ifndef __NVIDIOSO__cuda_int_lt__
#define __NVIDIOSO__cuda_int_lt__

#include "cuda_constraint.h"

class CudaIntLt : public CudaConstraint {
public:
   ...
   */
  __device__ CudaIntLt ( int n_id, int n_vars, int n_args,
                         int* vars, int* args,
                         int* domain_idx, uint* domain_states );
  
  __device__ ~CudaIntLt ();
