...
#ifndef __NVIDIOSO__cuda_int_min_c__
#define __NVIDIOSO__cuda_int_min_c__

#include "cuda_constraint.h"

class CudaIntMinC : public CudaConstraint {
public:
   ...
   */
  __device__ CudaIntMinC ( int n_id, int n_vars, int n_args,
                           int* vars, int* args,
                           int* domain_idx, uint* domain_states );
  
  __device__ ~CudaIntMinC ();
