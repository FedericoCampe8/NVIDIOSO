...
#ifndef __NVIDIOSO__cuda_set_sym_diff__
#define __NVIDIOSO__cuda_set_sym_diff__

#include "cuda_constraint.h"

class CudaSetSymDiff : public CudaConstraint {
public:
   ...
   */
  __device__ CudaSetSymDiff ( int n_id, int n_vars, int n_args,
                              int* vars, int* args,
                              int* domain_idx, uint* domain_states );
  
  __device__ ~CudaSetSymDiff ();
