...
#ifndef __NVIDIOSO__cuda_int_times__
#define __NVIDIOSO__cuda_int_times__

#include "cuda_constraint.h"

class CudaIntTimes : public CudaConstraint {
public:
   ...
   */
  __device__ CudaIntTimes ( int n_id, int n_vars, int n_args,
                            int* vars, int* args,
                            int* domain_idx, uint* domain_states );
  
  __device__ ~CudaIntTimes ();
