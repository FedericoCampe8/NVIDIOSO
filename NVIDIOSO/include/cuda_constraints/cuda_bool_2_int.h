...
#ifndef __NVIDIOSO__cuda_bool_2_int__
#define __NVIDIOSO__cuda_bool_2_int__

#include "cuda_constraint.h"

class CudaBool2Int : public CudaConstraint {
public:
   ...
   */
  __device__ CudaBool2Int ( int n_id, int n_vars, int n_args,
                            int* vars, int* args,
