...
#ifndef __NVIDIOSO__cuda_bool_and__
#define __NVIDIOSO__cuda_bool_and__

#include "cuda_constraint.h"

class CudaBoolAnd : public CudaConstraint {
public:
   ...
   */
  __device__ CudaBoolAnd ( int n_id, int n_vars, int n_args,
                           int* vars, int* args,
                           int* domain_idx, uint* domain_states );
  
  __device__ ~CudaBoolAnd ();
