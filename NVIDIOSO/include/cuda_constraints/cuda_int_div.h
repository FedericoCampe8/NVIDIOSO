...
#ifndef __NVIDIOSO__cuda_int_div__
#define __NVIDIOSO__cuda_int_div__

#include "cuda_constraint.h"

class CudaIntDiv : public CudaConstraint {
public:
   ...
   */
  __device__ CudaIntDiv ( int n_id, int n_vars, int n_args,
                          int* vars, int* args,
                          int* domain_idx, uint* domain_states );
  
  __device__ ~CudaIntDiv ();
