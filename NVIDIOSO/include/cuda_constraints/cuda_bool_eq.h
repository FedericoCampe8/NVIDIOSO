...
#ifndef __NVIDIOSO__cuda_bool_eq__
#define __NVIDIOSO__cuda_bool_eq__

#include "cuda_constraint.h"

class CudaBoolEq : public CudaConstraint {
public:
   ...
   */
  __device__ CudaBoolEq ( int n_id, int n_vars, int n_args,
                          int* vars, int* args,
                          int* domain_idx, uint* domain_states );
  
  __device__ ~CudaBoolEq ();
