...
CudaSimpleConstraintStoreSeq::dev_consistency ()
{
	...
	CudaPropUtils::cuda_consistency_sequential <<< 1, 1, 0 >>> ( _d_constraint_queue, _constraint_queue.size() );
	CudaSynchUtils::cuda_set_domains_from_bit_1b1v <<< _cp_model_ptr->num_variables (), dev_block_size, STANDARD_DOM >>>
